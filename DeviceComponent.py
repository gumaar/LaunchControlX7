...
# Internal filename: output/Live/mac_universal_64_static/Release/python-bundle/MIDI Remote Scripts/Launch_Control_XL/DeviceComponent.py
...
class DeviceModeComponent(EnablingModesComponent):
    ...
    def _update_buttons(self, selected_mode):
        self.device_mode_button.color = (
            "DefaultButton.On" if selected_mode == "enabled" else "DefaultButton.Off"
        )
